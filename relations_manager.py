...
class RelationsManager:
    def __init__(self):
        self.employee_list = [
            ...
            Employee(id=2, first_name="Myrta", last_name="Tucson", base_salary=1000,
                     birth_date=datetime.date(1980, 1, 1), hire_date=datetime.date(2000, 1, 1)),

            Employee(id=3, first_name="Jenny", last_name="Lynch", base_salary=1500,
            ...
            Employee(id=6, first_name="Scotty", last_name="Bilbo", base_salary=1300,
